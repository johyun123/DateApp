...
function GameDate({ navigation }){
    ...
    async function loadService(){
        ...
        const filtered = list.filter(item=>item.type == "게임 데이트")
        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <View style={styles.headerTop}>
                    <Ionicons name="game-controller" size={28} color="#FF6B9D" />
                    <Text style={styles.headerTitle}>게임 데이트</Text>
                </View>
