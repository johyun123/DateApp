...
function SnsModel({ navigation }){
    ...
    async function loadService(){
        ...
        const filtered = list.filter(item=>item.type == "SNS 사진 모델")
        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <View style={styles.headerTop}>
                    <Ionicons name="camera" size={28} color="#CC5DE8" />
                    <Text style={styles.headerTitle}>SNS 사진 모델</Text>
                </View>
