// ServiceList_Styled.tsx
// 모든 서비스 리스트 페이지에 적용할 수 있는 스타일 템플릿
// AdviceDate, CallDate, DailyDate, FassionModel, GameDate, SnsModel 모두 동일하게 적용
...
// ============================================
// 예시: DailyDate 스타일 적용 버전
// 다른 페이지도 동일하게 적용 가능
// ============================================

function DailyDate({ navigation }){
    ...
    async function loadService(){
        ...
        const filtered = list.filter(item=>item.type == "일일 데이트")
    ...
    function toggleLike(serviceId){
      setLikedIds(prev => {
        ...
        const isLiked = next.has(serviceId)
        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.header}>
                <View style={styles.headerTop}>
                    <Ionicons name="calendar" size={28} color="#4A9EFF" />
                    <Text style={styles.headerTitle}>일일 데이트</Text>
                </View>
                <Text style={styles.headerSubtitle}>
                    {serviceData.length}개의 서비스가 있습니다
                </Text>
            </View>
