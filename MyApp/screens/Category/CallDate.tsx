...
function CallDate({ navigation }){
    ...
    async function loadService(){
        ...
        const filtered = list.filter(item=>item.type == "전화 데이트")
        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <View style={styles.headerTop}>
                    <Ionicons name="call" size={28} color="#FFA94D" />
                    <Text style={styles.headerTitle}>전화 데이트</Text>
                </View>
