...
function FassionModel({ navigation }){
    ...
    async function loadService(){
        ...
        const filtered = list.filter(item=>item.type == "패션 모델")
        ...
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                <View style={styles.headerTop}>
                    <Ionicons name="shirt" size={28} color="#FF8787" />
                    <Text style={styles.headerTitle}>패션 모델</Text>
                </View>
